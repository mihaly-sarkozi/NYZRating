# backend/core/modules/tenant/signup/__init__.py
# Feladat: A canonical tenant signup csomag lazy exportfelülete. Demo signup, resend, unsubscribe, provisioning és token use case-eket ad tovább egy belépési pontról. Tenant onboarding façade.
