# backend/core/modules/tenant/service/signup/provisioner.py
...
"""Backward-compat shim → ``core.modules.tenant.provisioning.provisioner``."""
from __future__ import annotations

from core.modules.tenant.provisioning.provisioner import *  # noqa: F403
