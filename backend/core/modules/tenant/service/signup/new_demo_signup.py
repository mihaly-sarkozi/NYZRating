# backend/core/modules/tenant/service/signup/new_demo_signup.py
...
"""Backward-compat shim → core.modules.tenant.signup.new_demo_signup"""
from __future__ import annotations
from core.modules.tenant.signup.new_demo_signup import *  # noqa: F403
