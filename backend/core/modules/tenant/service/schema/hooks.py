# backend/core/modules/tenant/service/schema/hooks.py
...
"""Backward-compat shim → core.modules.tenant.schema.hooks"""
from __future__ import annotations
from core.modules.tenant.schema.hooks import *  # noqa: F403
