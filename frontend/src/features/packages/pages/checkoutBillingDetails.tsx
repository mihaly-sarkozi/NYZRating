...
import { FIXED_BILLING_COUNTRY, isValidHuTaxId, isValidPostalCode } from "../../billing/billingCountries";

export type BillingCustomerType = "company";

export function checkoutCustomerTypeFromSettings(_settings?: BillingSettingsResponse | null): BillingCustomerType {
  return "company";
}
...
export function hasSavedCheckoutBillingDetails(settings?: BillingSettingsResponse | null): boolean {
  ...
  return (
    ...
    (settings.billing_country === FIXED_BILLING_COUNTRY || !settings.billing_country) &&
