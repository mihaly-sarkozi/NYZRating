// frontend/src/features/settings/sections/security/AuthenticatorSetupModal.tsx
// Feladat: Authenticator setup wizard modal UI-only komponens lépésekre bontva.
// Sárközi Mihály - 2026.05.29

import { QRCodeSVG } from "qrcode.react";
import Button from "../../../../components/ui/Button";
import Modal, { ModalFooter, ModalHeader } from "../../../../components/ui/Modal";
import type { AuthenticatorSetupResponse } from "../../api/authenticatorService";
...
export default function AuthenticatorSetupModal({
  ...
  return (
    <Modal open onClose={onClose} closeOnOverlay={!confirmPending} panelClassName="max-w-2xl bg-[var(--color-background)]">
      <ModalHeader eyebrow={labels.eyebrow} title={labels.title} description={labels.description} />
